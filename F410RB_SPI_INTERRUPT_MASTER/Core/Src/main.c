...
/* USER CODE BEGIN PV */
uint8_t uartTxBuffer[] = "\r\n**SPI - INTERRUPT Modda iki kart haberlesmesi **** \r\n";
uint8_t aTxBuffer[] = "HELLO WORD...";
...
int main(void)
{
  ...
  if(HAL_UART_Transmit(&huart2, (uint8_t*)uartTxBuffer, 55, 5000)!= HAL_OK)
    ...
    if(HAL_SPI_TransmitReceive_IT(&hspi2, (uint8_t*)aTxBuffer, (uint8_t *)aRxBuffer, 43) != HAL_OK)
    {
      Error_Handler();
    }
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|GPIO_PIN_13|GPIO_PIN_9, GPIO_PIN_RESET);
